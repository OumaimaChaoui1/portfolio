        ...
        <ul class="navbar-nav text-uppercase ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="#contact">contact</a>
             ...
             <li class="lang">
          <a href="http://localhost/portfoliooma/?lang=en"><img src="en.png" width="25px" height="25px">
                  </a>
          <a id="fr" href="http://localhost/portfoliooma/?lang=fr"><img src="fr.ico" width="20px" height="20px">
                  </a>
                  </li>
        ...
        <div class="col-sm-4">
          <div class="team-member">
            ...
            <ul class="list-inline social-buttons">
              ...
              <li class="list-inline-item">
                <a href="http://localhost/portfoliooma/challenge/index.html" target="_blank">
        ...
        <div class="col-sm-4">
          <div class="team-member">
            ...
            <ul class="list-inline social-buttons">
              ...
              <li class="list-inline-item">
                <a href="http://localhost/portfoliooma/COUNTER/index.html" target="_blank">
                  <i class="fab fa fa-eye"></i>
                </a>
              </li>
              <li class="list-inline-item">
        ...
        <div class="col-sm-4">
          <div class="team-member">
            ...
            <ul class="list-inline social-buttons">
              ...
              <li class="list-inline-item">
                <a href="http://localhost/portfoliooma/css/index.html" target="_blank">
                  <i class="fab fa fa-eye"></i>
                </a>
              </li>
              <li class="list-inline-item">
        ...
        <div class="col-sm-4">
          <div class="team-member">
            ...
            <ul class="list-inline social-buttons">
              ...
              <li class="list-inline-item">
                <a href="http://localhost/portfoliooma/drum/index-FINISHED.html" target="_blank">
                  <i class="fab fa fa-eye"></i>
                </a>
              </li>
              <li class="list-inline-item">
        ...
        <div class="col-sm-4">
          <div class="team-member">
            ...
            <ul class="list-inline social-buttons">
              ...
              <li class="list-inline-item">
                <a href="http://localhost/portfoliooma/clock/index-FINISHED.html" target="_blank">
                  <i class="fab fa fa-eye"></i>
                </a>
              </li>
              <li class="list-inline-item">
        ...
        <div class="col-sm-4">
          <div class="team-member">
            ...
            <ul class="list-inline social-buttons">
              ...
              <li class="list-inline-item">
                <a href="http://localhost/portfoliooma/var/index-FINISHED.html" target="_blank">
                  <i class="fab fa fa-eye"></i>
                </a>
              </li>
              <li class="list-inline-item">
